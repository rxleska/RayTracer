...
__device__ bool scatter(const lambertian& self, const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered, curandState* curandState) {
    ...
    // add a small part of the normal to intersection point to avoid self-intersection
