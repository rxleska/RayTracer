...
class camera {
  public:
    ...
    camera() : aspect_ratio(16.0/9.0), image_width(1920), samples_per_pixel(1), max_depth(10), vfov(90), lookfrom(0,0,0), lookat(0,0,-1), vup(0,1,0), defocus_angle(0), focus_dist(10.0) {}
